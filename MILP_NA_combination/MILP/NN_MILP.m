...
load('Data/8ink_net_4lay_150_w_b.mat')

%Upper bounds and lower bounds
load('Data/lower_upper_bound_8ink_net_4lay_150.mat')

% Target to be optimized for
load('Data/gray_spec_gt')
%% Test vals
...
spec_test = double(gray_spec(401,:));
...
% x{1} = double(squeeze(backprob_inks))';
for lay =2:depth_ind
...
objective =   sum(sum(Z));
options = sdpsettings('solver','gurobi', 'gurobi.Threads', 0,  'gurobi.MIPFocus', 0,'gurobi.LogFile','sample_401_4lay_150.log');
tic
